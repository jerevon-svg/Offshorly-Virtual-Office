...
vi.mock("./world", async () => ({
  createVo3dWorld: () => {
    ...
    const world = {
      ...
      standUp: vi.fn(),
      setCoworkerInteractions: vi.fn(), subscribeViewMode: () => () => {}, subscribePlayerView: () => () => {}, setViewMode: vi.fn(), requestPointerLock: vi.fn(), setPlayerView: vi.fn(), devToolsVisible: () => false, setDevToolsVisible: vi.fn(), setConversationPoses: vi.fn(), setGlobalChatActive: vi.fn(), exitPlayerMode: vi.fn(), selectCoworkerByEmail: vi.fn(() => false),
      clearCoworkerSelection: vi.fn(),
      coworkerAnchor: vi.fn(() => null), coworkerAnchors: vi.fn(() => ({})),
      approachCoworker: vi.fn(() => false),
