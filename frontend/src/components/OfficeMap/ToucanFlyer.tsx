...
// THE SUMMON MACHINE now lives in ./toucanSummon — pure, THREE-free and shared with dev/vo3d's
// world-space bird, which parks on the same offset and arrives on the same radius. Nothing about it
// changed in the move; it is re-exported here so every existing importer (and toucanSummon.test.ts)
// still reaches it through this module.
export {
  attendFacePointFor,
  decideSummon,
  parkPointFor,
