...
// Player HUD — permanently owns the top-left corner: avatar + first name, Level, XP meter with
// current / required XP, and a dedicated Coins balance. Everything shown is the server's number:
...
export function PlayerHud() {
  ...
  if (!store.progression) return null;
  return (
    <HudBody
