...
export const SEAT_DIRECTIONS: Record<string, {
  ...
  "executive-team": { seats: { "588.41,91.68": "front", "864.22,91.68": "front", "726.20,158.69": "front", "551.46,162.22": "back", "576.09,162.22": "back", "600.72,162.22": "back", "625.35,162.22": "back", "827.26,162.22": "back", "851.90,162.22": "back", "876.53,162.22": "back", "901.16,162.22": "back", "726.20,254.84": "back", "880.95,258.18": "front" } },
  "dev-team": { seats: { "1207.81,75.02": "front", "1335.33,75.02": "front", "1196.41,118.49": "back", "1219.21,118.49": "back", "1323.93,118.49": "back", "1346.73,118.49": "back", "1176.71,156.47": "front", "1197.44,156.47": "front", "1218.18,156.47": "front", "1238.91,156.47": "front", "1304.23,156.47": "front", "1324.96,156.47": "front", "1345.70,156.47": "front", "1366.43,156.47": "front", "1174.68,232.78": "back", "1196.46,232.78": "back", "1218.23,232.78": "back", "1240.00,232.78": "back", "1302.20,232.78": "back", "1323.98,232.78": "back", "1345.75,232.78": "back", "1367.52,232.78": "back", "1144.47,273.50": "right" } },
  ...
  // Follow-up fix (8-connected flood-fill merge split): "146.67,704.00" was
  // the centroid of a single wrongly-merged blob covering 3 real chairs (the
  // 2 team-lead visitor chairs + the left-cluster-top chair) — repainting 2
  // tiles in walkable-source.png split it into 3 correctly-placed seats at
  // "152.00,696.00", "184.00,696.00", and "120.00,720.00". The stale merged
  // entry is removed (no seat lands there anymore); the 5 unaffected seats
  // below keep their original assignments. The 3 new seats have no entry yet
  // — they fall back to "front" via directionForSeat until Bon assigns real
  // directions via seat-direction-tool.html.
  "qa-room": { seats: { "160.00,648.00": "front", "224.00,720.00": "left", "59.56,740.44": "right", "120.00,768.00": "right", "224.00,768.00": "left" } },
  "design-team": { seats: { "164.79,397.49": "front", "94.22,401.72": "left", "235.36,401.72": "right", "94.22,434.21": "left", "235.36,434.21": "right", "114.66,487.89": "back", "164.80,487.89": "back", "214.93,487.89": "back", "48.17,509.59": "right", "107.27,534.15": "back" } },
  "gaming-room": { seats: { "1400.00,688.00": "front", "1216.00,704.00": "right", "1328.00,704.00": "left", "1272.00,744.00": "back", "1392.00,744.00": "back", "1200.00,792.00": "front", "1248.00,792.00": "front", "1296.00,792.00": "front", "1344.00,792.00": "front" } },
  ...
  "reception-room": { seats: { "477.82,1017.45": "front", "962.18,1017.45": "front", "416.00,1056.00": "right", "1024.00,1056.00": "left", "480.00,1112.00": "back", "960.00,1112.00": "back" } },
};
