...
class CallInviteStore(Protocol):
    ...
    # PHASE 7D: `extra` carries a meeting id when this registry instance is serving MEETING
    # invitations rather than spatial rings — see realtime/state.py's meeting_invites.
    def create(
        self, *, from_email: str, from_sid: str, to_email: str, extra: dict | None = None
    ) -> dict: ...
