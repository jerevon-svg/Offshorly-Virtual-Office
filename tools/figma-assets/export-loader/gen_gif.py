...
def render_frame(t, pct):
    ...
    # header text
    d.text((s(24), s(29)), "Export Candidates", font=SERIF, fill=hex2rgb(DARK), anchor="lm")
    d.text((s(24), s(68)), "Preparing your export", font=SANS_16_MED, fill=hex2rgb(DARK), anchor="lm")
    d.text((s(24), s(91)), "Please wait while we generate your candidate export",
    ...
    d.text((s(RING_CX), s(263)), "candidates_export_2026_31_07.csv", font=SANS_14_MED, fill=hex2rgb(DARK), anchor="mm")
    d.text((s(RING_CX), s(284)), "5.2 MB", font=SANS_14, fill=hex2rgb(GRAY), anchor="mm")
...
if __name__ == "__main__":
    out = "/Users/lekoffshorly/Documents/AI Agents/figma-assets/export-loader/export_loader.gif"
    build_gif(out)
    import os
